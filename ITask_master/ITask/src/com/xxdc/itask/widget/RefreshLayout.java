...
public class RefreshLayout extends SwipeRefreshLayout implements OnScrollListener {
    ...
    private boolean isBottom() {
        if (mListView != null && (HistoryTaskAdapter)mListView.getAdapter() != null) {
            return mListView.getLastVisiblePosition() == (((HistoryTaskAdapter)mListView.getAdapter()).getGroupCount() - 1);
        }
        return false;
    }
