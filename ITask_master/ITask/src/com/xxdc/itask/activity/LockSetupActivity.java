...
import com.xxdc.lib.gusturelock.LockPatternView.DisplayMode;
import com.xxdc.lib.gusturelock.LockPatternView.OnPatternListener;
...
public class LockSetupActivity extends BaseActivity {
	...
	enum RightButtonMode {
		Continue(R.string.lockpattern_continue_button_text, true), ContinueDisabled(R.string.lockpattern_continue_button_text, false), Confirm(
				R.string.lockpattern_confirm_button_text, true), ConfirmDisabled(R.string.lockpattern_confirm_button_text, false), Ok(android.R.string.ok, true);
	...
	protected enum Stage {
		...
		Introduction(R.string.lockpattern_recording_intro_header, LeftButtonMode.Cancel, RightButtonMode.ContinueDisabled, ID_EMPTY_MESSAGE, true), HelpScreen(
				R.string.lockpattern_settings_help_how_to_record, LeftButtonMode.Gone, RightButtonMode.Ok, ID_EMPTY_MESSAGE, false), ChoiceTooShort(
				R.string.lockpattern_recording_incorrect_too_short, LeftButtonMode.Retry, RightButtonMode.ContinueDisabled, ID_EMPTY_MESSAGE, true), FirstChoiceValid(
	...
	public static void launch(Activity activity) {
		Intent i = new Intent(activity, LockSetupActivity.class);
	...
	private void saveChosenPatternAndFinish() {
		ITaskApp.getInstance().getLockPatternUtils().saveLockPattern(mChosenPattern);
