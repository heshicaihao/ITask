...
public class GridNomalAdapter extends BaseAdapter {
	...
	public GridNomalAdapter() {

	}

	public GridNomalAdapter(Context context, GridView mGv, List<Drawable> lists, CallBack callBack) {
